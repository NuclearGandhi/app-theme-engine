 ...
 */
@SuppressLint("NewApi")
public class SupportSettingsActivity extends BaseThemedActivity
    ...
    public static class SupportSettingsFragment extends ATEPreferenceFragmentCompat {
        ...
        public void invalidateSettings() {
            mAteKey = ((SupportSettingsActivity) getActivity()).getATEKey();
            ...
            final ATEListPreference lightStatusMode = (ATEListPreference) findPreference("light_status_bar_mode");
            final ATEListPreference lightToolbarMode = (ATEListPreference) findPreference("light_toolbar_mode");
            ...
            final Preference.OnPreferenceClickListener textsizeClickListener = new Preference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    TextSizeDialog.show(getActivity(), preference.getKey(), mAteKey, preference.getTitle(), true);
                    return false;
                }
            };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, new SupportSettingsFragment()).commit();
        } else {
            SupportSettingsFragment frag = (SupportSettingsFragment) getSupportFragmentManager().findFragmentById(R.id.content_frame);
